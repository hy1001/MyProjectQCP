...
arrayInitialConditions_qayxsw = c();
...
## %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
## try
##     [my.IQMmodel.functions, errorFunctions] = getFunctions(modelTextStructure.functions);
## catch
...
## %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
## try
##     [my.IQMmodel.events, errorEvents] = getEvents(modelTextStructure.events);
## catch
...
## %%%%%%%%%%%%%%%%%% MATLAB functions
## %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
## my.IQMmodel.functionsMATLAB = modelTextStructure.functionsMATLAB;
...
##     my.IQMmodel.states(k).ODE = ['constraints_factor_' statename ' * (' ODE ')'];
##     % define the "constraints_factor_statename" in the reactions
##     my.IQMmodel.reactions(end+1).name = ['constraints_factor_' statename];
...
##     my.IQMmodel.reactions(end).formula = pwtext;
##     my.IQMmodel.reactions(end).notes = sprintf('Implementation of constraints on state %s',statename);
##     my.IQMmodel.reactions(end).reversible = 0;
